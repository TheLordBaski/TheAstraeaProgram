...
- [x] parachute deployed too fast is torn by the canopy load: Failed: torn by aerodynamic load (102 kN > 100 kN at 329 m/s) (armed at 4.8 km, 387 m/s, q 43 kPa; peak canopy load 99 kN)
...
## Log
    [AutoTest        1.6] PHASE structural overload
    [AutoTest        5.6] CHECK PASS: overloaded joint fails from simulated loads — structural failure at SD-1 Stack Decoupler joint (244 kN tension > 180 kN; vessel 1.3 g, α 0.0 rad/s², ω 0.00 rad/s)
    [AutoTest        5.6] CHECK PASS: broken-off parts continue as a separate vessel — 2 loaded vessels (was 1)
    ...
    [AutoTest       53.5] CHECK PASS: parachute deployed too fast is torn by the canopy load — Failed: torn by aerodynamic load (102 kN > 100 kN at 329 m/s) (armed at 4.8 km, 387 m/s, q 43 kPa; peak canopy load 99 kN)
    [AutoTest       87.7] CHECK PASS: high-speed impact destroys the capsule (collision damage) — Kestrel-1 Command Pod destroyed: splashdown at 111.6 m/s
    [AutoTest       87.7] CHECK PASS: crew loss is reported — Bram Holloway was lost (splashdown at 111.6 m/s)
