...
- [x] docking ports capture and merge the vessels: captured 23 s after the start at 0.25 m/s and 0.3° (last sample 0.60 m apart); Dock Chaser: 10 parts, 1.96 t, crew 1
...
## Log
    ...
    [AutoTest        8.6] approach: 6.92 m to go, 0.01 m off-axis, closing 0.48 m/s (want 0.50), RCS (0.07, 0.05, 0.00), spin 0.00 / 0.00 rad/s
    ...
    [AutoTest       26.0] CHECK PASS: docking ports capture and merge the vessels — captured 23 s after the start at 0.25 m/s and 0.3° (last sample 0.60 m apart); Dock Chaser: 10 parts, 1.96 t, crew 1
