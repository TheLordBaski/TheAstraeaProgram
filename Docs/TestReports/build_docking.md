...
- [x] docking ports capture and merge the vessels: captured 23 s after the start at 0.25 m/s and 0.4° (last sample 0.59 m apart); Dock Chaser: 10 parts, 1.96 t, crew 1
...
## Log
    ...
    [AutoTest        8.6] approach: 6.92 m to go, 0.01 m off-axis, closing 0.49 m/s (want 0.50), RCS (0.07, 0.04, 0.00), spin 0.00 / 0.00 rad/s
    [AutoTest       10.6] approach: 5.94 m to go, 0.01 m off-axis, closing 0.49 m/s (want 0.50), RCS (0.07, 0.04, 0.00), spin 0.00 / 0.00 rad/s
    [AutoTest       12.6] approach: 4.96 m to go, 0.01 m off-axis, closing 0.49 m/s (want 0.50), RCS (-0.15, 0.02, 0.00), spin 0.00 / 0.00 rad/s
    [AutoTest       14.7] approach: 4.03 m to go, 0.01 m off-axis, closing 0.42 m/s (want 0.40), RCS (-0.15, -0.05, 0.00), spin 0.00 / 0.00 rad/s
    [AutoTest       16.7] approach: 3.27 m to go, 0.01 m off-axis, closing 0.34 m/s (want 0.33), RCS (0.08, -0.03, 0.00), spin 0.00 / 0.00 rad/s
    [AutoTest       18.7] approach: 2.63 m to go, 0.01 m off-axis, closing 0.29 m/s (want 0.26), RCS (0.07, -0.09, 0.00), spin 0.00 / 0.00 rad/s
    [AutoTest       20.7] approach: 2.03 m to go, 0.00 m off-axis, closing 0.29 m/s (want 0.20), RCS (-0.08, -0.26, 0.00), spin 0.01 / 0.00 rad/s
    [AutoTest       22.7] approach: 1.46 m to go, 0.00 m off-axis, closing 0.26 m/s (want 0.15), RCS (-0.05, -0.34, 0.00), spin 0.00 / 0.01 rad/s
    [AutoTest       24.8] approach: 0.93 m to go, 0.00 m off-axis, closing 0.26 m/s (want 0.15), RCS (0.02, -0.34, 0.00), spin 0.00 / 0.00 rad/s
    [AutoTest       26.0] CHECK PASS: docking ports capture and merge the vessels — captured 23 s after the start at 0.25 m/s and 0.4° (last sample 0.59 m apart); Dock Chaser: 10 parts, 1.96 t, crew 1
    [AutoTest       26.0] screenshot: docking_017_docked.png
    [AutoTest       36.1] CHECK PASS: docked stack holds together — 10 parts after 10 s, mass 1.96 t (sum 1.97 t), crew 1
    [AutoTest       36.1] PHASE undocking
